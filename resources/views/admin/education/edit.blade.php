    ...
    <div class="col-12 col-xl-6">
        <div class="card redial-border-light redial-shadow mb-4">
            <div class="card-body">
                ...
                <form method="post"
                      action="{{route('admin.educations.update',['education' => $education->id])}}">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sub_name" class="form-control" placeholder="Enter Sub name"
                               value="{{old('sub_name',$education->sub_name)}}">
                    </div>
                    <div class="form-group">
                        <label class="redial-font-weight-600 d-block">Description</label>
                        <textarea type="text" name="description" class="form-control"
                                  placeholder="Enter Description">{{old('description',$education->description)}}</textarea>
                    </div>
                    <div class="form-group">
