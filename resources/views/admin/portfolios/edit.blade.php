    ...
    <div class="col-12 col-xl-6">
        <div class="card redial-border-light redial-shadow mb-4">
            <div class="card-body">
                ...
                <form method="post"
                      action="{{route('admin.portfolios.update',['portfolio' => $portfolio->id])}}">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="description" class="form-control" placeholder="Enter Description">{{old('description',$portfolio->description)}}</textarea>
                    </div>
                    <div class="form-group">
                        <label class="redial-font-weight-600">Site</label>
                        <input type="text" name="site" class="form-control" placeholder="Enter Site"
                               value="{{old('site',$portfolio->site)}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="priority" class="form-control" placeholder="Enter Priority"
                               value="{{old('priority',$portfolio->priority)}}">
                    </div>
